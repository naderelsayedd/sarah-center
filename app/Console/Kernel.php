...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        Commands\SendStaffDocumentNotification::class,
		Commands\SendStudentDocumentNotification::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        if (config('app.app_sync') && Storage::exists('.app_resetting')) {
            ...
            $schedule->command('document_notification:reminder')->dailyAt('06:00');
			$schedule->command('student_document_notification:reminder')->dailyAt('05:00');
        }
    }
