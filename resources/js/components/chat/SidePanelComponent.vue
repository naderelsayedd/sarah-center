                    ...
                    <div class="search_inner">
                        <form :action="search_url" method="GET">
                            <div class="search_field">
                                <input type="text1" name="keywords" :placeholder="__('text_search')" id="users_list_sidebar" onkeyup="showChatUser(this.value)">
                            </div>
                            <button type="submit"> <i class="ti-search"></i> </button>
                        </form>
						 <div id="liveChatSearch" style="display: none;"></div>
                    </div>
                </div>
                <ul>
                    <div v-if="1===1">
