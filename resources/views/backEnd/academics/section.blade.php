                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   @if (userPermission('section_edit'))
                                                            <a class="primary-btn small fix-gr-bg"  href="{{route('section_edit', [$section->id])}}" title="__('common.edit')"><i class="ti-pencil" style="font-size: 20px;"></i></a>
                                                    @endif        
                                                    @if (userPermission('section_delete'))
                                                            <a  class="primary-btn small fix-gr-bg" href="#" data-toggle="modal"  data-target="#deleteSectionModal{{$section->id}}"  title=" __('common.delete')" ><i class="ti-trash" style="font-size: 20px;"></i></a>
                                                    @endif     
