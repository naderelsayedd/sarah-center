                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <label class="primary_input_label" for="">@lang('academics.teacher') <span class="text-danger"> *</span> <a href="/add-staff" class="add_new pull-right" data-toggle="tooltip" title="Add Account Role as Teacher" data-original-title="Add Account Role as Teacher"><span class="ti-plus"></span> Add</a></label>
