                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <label class="primary_input_label" for="">@lang('common.section')<span class="text-danger"> *</span> <a href="/section" class="add_new pull-right" data-toggle="tooltip" title="Add Section" data-original-title="Add Section"><span class="ti-plus"></span> Add</a></label>
                                                ...
                                                @php
                                                   ...
                                                   echo $btn =
                                                        (userPermission('class_edit') ?
                                                            '<a class="primary-btn small fix-gr-bg"  href="' . route('class_edit', [@$class->id]) . '" title="'.__('common.edit').'"><i class="ti-pencil" style="font-size: 20px;"></i></a><br>' : null).
                                                       
                                                        (userPermission('class_delete') ? 
                                                            ' <a  class="primary-btn small fix-gr-bg" href="'.route('class_delete', [@$class->id]).'" data-toggle="modal"  data-target="#deleteClassModal'.$class->id.'"  title="'. __('common.delete') .'" ><i class="ti-trash" style="font-size: 20px;"></i></a>' : null);
