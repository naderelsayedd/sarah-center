            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                <label class="primary_input_label" for="">@lang('communicate.file') <span
                                        class="text-danger"> *</span> </label>
                                <input
                                    class="primary_input_field form-control{{ $errors->has('upload_file_name') ? ' is-invalid' : '' }} commonInputBlank"
                                    type="file" name="upload_file_name" id="upload_file_name" autocomplete="off"
                                    value="{{ isset($editData) ? $editData->upload_file_name : old('upload_file_name') }}">
                                <span id="error_upload_file_name" class="text-danger commonErrorBlank"></span>
                            </div>
                        </div>
