                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-30 ">
                            ...
                            <div class="col-lg-6">
                                <p class="text-uppercase mb-2">@lang('fees::feesModule.vat_on_fees')</p>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                                        <input type="radio" name="vat_on_fees" id="fees_enable" value="1" class="common-radio relationButton" {{@$editData->vat_on_fees == "1"? 'checked': ''}}>
                                        <label for="fees_enable">@lang('system_settings.enable')</label>
                                    </div>
                                    <div class="mr-20">
                                        <input type="radio" name="vat_on_fees" id="fees_disable" value="0" class="common-radio relationButton" {{@$editData->vat_on_fees == "0"? 'checked': ''}}>
                        ...
                        <div class="row md-30 mt-20">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('system_settings.school_address') <span class="text-danger">*</span>  <a href="javascript:;" onclick="getLatLong()">Get Lat Long</a></label>
									<textarea class="primary_input_field form-control" cols="0" rows="4" name="address" id="school_address">{{isset($editData) ? @$editData->address : old('address')}}</textarea>
						...
						<div class="row md-30 mt-20">
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.lat') </label>
									<input type="text" class="primary_input_field form-control"  name="lat" id="lat" value="{{isset($editData) ? @$editData->lat : old('lat')}}" />
						...
						<div class="row md-30 mt-20">
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.long') </label>
									<input type="text" class="primary_input_field form-control"  name="long" id="long" value="{{isset($editData) ? @$editData->long : old('long')}}" />
						...
						<div class="row md-30 mt-20">
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.range_in_miles') </label>
									<input type="text" class="primary_input_field form-control"  name="range_in_miles" id="range_in_miles" value="{{isset($editData) ? @$editData->range_in_miles : old('range_in_miles')}}" /> 
									@if ($errors->has('range_in_miles'))
									<span class="text-danger" >
										{{ $errors->first('range_in_miles') }}
									</span>
									@endif
								</div>
							</div>
						...
						<div class="row md-30 mt-20">
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.vat') (%)<span class="text-danger">*</span> </label>
									<input type="text" class="primary_input_field form-control"  name="vat" id="vat" value="{{isset($editData) ? @$editData->vat : old('vat')}}" />
