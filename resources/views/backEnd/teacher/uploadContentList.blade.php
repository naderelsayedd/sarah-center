                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mb-20">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
											<a href="javascript:;" data-toggle="modal" data-target="#modalPopCheckMathematics" style="float:right" onclick="showMethameticsSymboles()">Check Mathematics</a>
                                                ...
                                                <textarea class="primary_input_field form-control generated-text mathematicsSymbol" cols="0" rows="3" name="description"
