                    ...
                    <div class="">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input">
                                    ...
                                    <input readonly oninput="emailCheck(this)" class="primary_input_field form-control{{ $errors->has('email_address') ? ' is-invalid' : '' }}" type="text" name="email_address" value="{{$student->email}}">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <select id="select_category" class="primary_select  form-control{{ $errors->has('student_category_id') ? ' is-invalid' : '' }}" name="student_category_id">
                            ...
                            <div class="col-lg-2">
                                <div class="primary_input" id="select_group_div">
                                    ...
                                    <select id="select_group" class="primary_select  form-control{{ $errors->has('student_group_id') ? ' is-invalid' : '' }}" name="student_group_id">
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        ...
                                        <input readonly class="primary_input_field form-control{{ $errors->has('guardians_email') ? ' is-invalid' : '' }}" type="text" name="guardians_email" id="guardians_email" value="{{$student->parents->guardians_email}}">
                        ...
                        <div class="row mt-40 mb-4">
                         ...
                         <div class="row mb-20">
                             @if(in_array('document_file_1', $fields))
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        <input class="primary_input_field" type="hidden" name="document_title_1" value="@lang('common.health_document')">
