                    ...
                    <div class="student-meta-box">
                        ...
                        @if (is_show('photo'))
                            <img class="student-meta-img img-100"
                                 ...
                                 alt="">
                        @endif
						<a href="{{ route('update-my-children', $student_detail->id) }}" class="primary-btn fix-gr-bg submit pull-right">Edit {{ $student_detail->full_name }} Profile</a>
                            ...
                            <div class="white-box">
								...
								<div class="single-info">
									<div class="row">
										<div class="col-lg-5 col-md-5">
											<div class="">
												@lang('auth.is_confirmation')
											</div>
										</div>
										<div class="col-lg-7 col-md-6">
											<div class="">
												{{ getUserField(@$student_detail->user_id,"is_confirmation") }}
											</div>
										</div>
									</div>
								</div>
								...
								<div class="single-info">
									<div class="row">
										<div class="col-lg-5 col-md-5">
											<div class="">
												@lang('auth.is_photo_confirmation')
											</div>
										</div>
										<div class="col-lg-7 col-md-6">
											<div class="">
												{{ getUserField(@$student_detail->user_id,'is_photo_confirmation') }}
											</div>
										</div>
									</div>
								</div>
