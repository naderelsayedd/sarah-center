                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        ...
                        @else
                            ...
                            <div class="col-lg-3 mt-30-md md_mb_20">
                                <select class="primary_select form-control {{ $errors->has('student_id') ? ' is-invalid' : '' }}" name="student_id" id="studentypeID">
                                    <option data-display="@lang('common.select_student') *" value="">@lang('common.select_student')*</option>
                                    @foreach($students as $student)
                                        <option value="{{$student->id}}"  {{isset($student_id)? ($student_id == $student->id? 'selected':''):''}}>{{$student->first_name}}</option>
                                    @endforeach
                                </select>
