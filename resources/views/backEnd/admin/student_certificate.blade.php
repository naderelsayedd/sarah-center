                                    ...
                                    <tr>
                                        ...
                                        <td>
											@php
                                                    ...
                                                    '<a class="primary-btn small fix-gr-bg"  href="#" data-toggle="modal" data-target="#showCertificateModal'.$certificate->id.'" title="'.__('common.view').'"><i class="ti-view-grid" style="font-size: 20px;"></i></a><br>':'').
                                                    (userPermission('student-certificate-edit') ?
                                                    '<a  class="primary-btn small fix-gr-bg" href="' . route('student-certificate-edit', [$certificate->id]) . '" title="'. __('common.edit') .'" ><i class="ti-pencil" style="font-size: 20px;"></i></a><br>' : '').
													(userPermission('student-certificate-delete') ?
                                                    '<a  class="primary-btn small fix-gr-bg"  data-toggle="modal" data-target="#deleteSectionModal'.$certificate->id.'"  href="#"  title="'. __('common.delete') .'" ><i class="ti-trash" style="font-size: 20px;"></i></a><br>' : '');
											@endphp
                                           <?php /*<x-drop-down>
