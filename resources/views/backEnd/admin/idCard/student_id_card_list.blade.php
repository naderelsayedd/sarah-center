                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               @php
													echo $btn = 
                                                    '<a  class="primary-btn small fix-gr-bg" data-toggle="modal" data-target="#previewIdCard'.$id_card->id.'"  href="#" title="'. __('admin.preview') .'" ><i class="ti-layout-width-default" style="font-size: 20px;"></i></a><br>'.
													(userPermission('student-id-card-edit') ?
                                                    '<a  class="primary-btn small fix-gr-bg" href="' . route('student-id-card-edit', [$id_card->id]) . '" title="'. __('common.edit') .'" ><i class="ti-pencil" style="font-size: 20px;"></i></a><br>' : '').
													(userPermission('student-id-card-delete') ?
                                                    '<a  class="primary-btn small fix-gr-bg"  data-toggle="modal" data-target="#deleteIdCard'.$id_card->id.'"  href="#"  title="'. __('common.delete') .'" ><i class="ti-trash" style="font-size: 20px;"></i></a><br>' : '');
											@endphp
                                                <?php /*<x-drop-down>
