							...
							<div class="add-visitor">
								<div class="row">
									<div class="col-lg-12">                               
										...
										<br>
										<div class="primary_input">
											<label class="primary_input_label" for="">@lang('common.is_docs_required') </label>
											<div class="mr-20">
												<input type="radio" name="is_docs_required"	id="is_docs_required_yes" value="1"	class="common-radio" {{ isset($leave_type) && $leave_type->is_docs_required == 1 ? 'checked' : ''}} >
												<label for="is_docs_required_yes">@lang('common.yes')</label>
											</div>
											<div class="mr-20">
												<input type="radio" name="is_docs_required"	id="is_docs_required_yes" value="0"	class="common-radio" {{ isset($leave_type) && $leave_type->is_docs_required == 0 ? 'checked' : ''}} >
												<label for="is_docs_required_yes">@lang('common.no')</label>
											</div>
										</div>
									</div>
								</div>
							...
							<table id="table_id" class="table" cellspacing="0" width="100%">
								...
								<thead>
									...
									<tr>
										...
										<th>@lang('common.is_docs_required') </th>
								...
								<tbody>
									...
									<tr>
										...
										<td>
										@if($leave_type->is_docs_required == 0) 
											@lang('common.no') 
										@else
											@lang('common.yes')
										@endif
