		...
		<div class="row">
				...
				<div class="student-meta-box">
					...
					<div class="white-box">
						...
						<div class="single-meta">
							<div class="d-flex justify-content-between">
								...
								<div class="value">
									...
									@if (isset($staffDetails))
									{{ !empty($staffDetails->nationality) ? $staffDetails->nationality : '' }}
									@endif
						...
						<div class="single-meta">
							<div class="d-flex justify-content-between">
								<div class="name">
									<span {{ $staffDetails->nationality == 'saudi' ? 'style=display:block' : 'style=display:none' }}>@lang('student.national_id_number')</span>	<span {{ $staffDetails->nationality != 'saudi' ? 'style=display:block' : 'style=display:none' }}>@lang('student.iqam_number')</span>										
								</div>
								<div class="value">
									
									@if (isset($staffDetails))
									{{ !empty($staffDetails->national_id_number) ? $staffDetails->national_id_number : '' }}
									@endif
			...
			<div class="col-lg-9 staff-details">
				<ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
					<li class="nav-item">
						<a class="nav-link @if (Session::get('staffDocuments') != 'active' && Session::get('staffTimeline') != 'active' && Session::get('staffInventory') != 'active') active @endif" href="#studentProfile"
					...
					<li class="nav-item">
						<a class="nav-link" href="#allowance" role="tab" data-toggle="tab">@lang('common.allowance')</a>
					</li>
					<li class="nav-item">
						<a class="nav-link {{ Session::get('staffInventory') == 'active' ? 'active' : '' }}" href="#provide_inventory" role="tab" data-toggle="tab">@lang('common.provide_inventory')</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#teacher_class" role="tab" data-toggle="tab">@lang('common.teacher_class')</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#teacher_subject" role="tab" data-toggle="tab">@lang('common.teacher_subject')</a>
					</li>
				...
				<div class="tab-content">
					<!-- Start Profile Tab -->
					<div role="tabpanel" class="tab-pane fade @if (Session::get('staffDocuments') != 'active' && Session::get('staffInventory') != 'active') != 'active'  && Session::get('staffTimeline') != 'active') show active @endif"
					id="studentProfile">
						<div class="white-box">
						...
						<div class="white-box">
							...
							cellspacing="0">
								...
								<tbody class="d-block">
									...
									@if ($staffDetails->specilized_certificate != '')
									<tr class="d-flex">
										<td class="col-7">@lang('common.specilized_certificate')</td>
										<td class="col-5 d-flex align-itemd-center">
											<a href="{{ url($staffDetails->specilized_certificate) }}" download>
												<button class="primary-btn tr-bg text-uppercase bord-rad">
													@lang('common.download')
													<span class="pl ti-download"></span>
												</button>
											...
											<a class="primary-btn icon-only fix-gr-bg ml-2"
											onclick="deleteStaffDoc({{ $staffDetails->id }},4)"
											data-id="4"
											href="#">
												<span class="ti-trash"></span>
											</a>
									...
									@if ($staffDetails->certificate != '')
									<tr class="d-flex">
										<td class="col-7">@lang('common.certificate')</td>
										<td class="col-5 d-flex align-itemd-center">
											<a href="{{ url($staffDetails->certificate) }}" download>
												<button class="primary-btn tr-bg text-uppercase bord-rad">
													@lang('common.download')
													<span class="pl ti-download"></span>
												</button>
											...
											<a class="primary-btn icon-only fix-gr-bg ml-2"
											onclick="deleteStaffDoc({{ $staffDetails->id }},5)"
											data-id="5"
											href="#">
												<span class="ti-trash"></span>
											</a>
					...
					{{-- Start allowance Tab --}}
					<div role="tabpanel" class="tab-pane fade" id="allowance">
						<div class="white-box">
							<h4 class="stu-sub-head">@lang('common.allowance')</h4>
							<div class="single-meta">
								<div class="d-flex justify-content-between">
									<div class="name">
										@lang('hr.basic_salary')
							...
							<div class="single-info">
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="">
											@lang('common.transportation_allowance')
										</div>
									</div>
									<div class="col-lg-7 col-md-6">
										<div class="">
											@if (isset($staffDetails))
											{{ currency_format($staffDetails->transportation_allowance) }}
											@endif
										</div>
									</div>
								</div>
							...
							<div class="single-info">
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="">
											@lang('common.housing_allowance')
										</div>
									</div>
									<div class="col-lg-7 col-md-6">
										<div class="">
											@if (isset($staffDetails))
											{{ currency_format($staffDetails->housing_allowance) }}
											@endif
										</div>
									</div>
								</div>
							...
							<div class="single-info">	
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="">
											@lang('common.other_allowance')
										</div>
									</div>
									<div class="col-lg-7 col-md-6">
										<div class="">
											@if (isset($staffDetails))
											{{ currency_format($staffDetails->other_allowance) }}
											@endif
										</div>
									</div>
								</div>
							...
							<div class="single-info">	
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="">
											@lang('common.medical_insurance_number')
										</div>
									</div>
									<div class="col-lg-7 col-md-6">
										<div class="">
											@if (isset($staffDetails))
											{{ currency_format($staffDetails->medical_insurance_number) }}
											@endif
										</div>
									</div>
								</div>
							...
							<div class="single-info">	
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="">
											@lang('common.social_insurance_number')
										</div>
									</div>
									<div class="col-lg-7 col-md-6">
										<div class="">
											@if (isset($staffDetails))
											{{ currency_format($staffDetails->social_insurance_number) }}
											@endif
										</div>
									</div>
								</div>
					...
					{{-- Start Teacher Class Tab --}}
					<div role="tabpanel" class="tab-pane fade" id="teacher_class">
						<div class="white-box">
							<h4 class="stu-sub-head">@lang('common.teacher_class')</h4>
							<div class="single-meta">
								<div class="col-lg-12">
									<table id="table_id" class="table" cellspacing="0" width="100%">
										<thead>
										...
										<tbody>
											@foreach ($assign_class_teachers as $class_teachers)
											<tr>
												<td>{{ @$class_teachers->class->id }}</td>
												<td>{{ @$class_teachers->class->class_name }}</td>
					...
					{{-- End Teacher Class Tab --}}

					{{-- Start Teacher Subject Tab --}}
					<div role="tabpanel" class="tab-pane fade" id="teacher_subject">
						<div class="white-box">
							<h4 class="stu-sub-head">@lang('common.teacher_subject')</h4>
							<div class="single-meta">
								<div class="col-lg-12">
									<table id="table_id" class="table" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>@lang('common.id')</th>
												<th>@lang('common.subject_type') </th>
											</tr>
										</thead>
										<tbody>
											@foreach ($subjects as $subjects_name)
											<tr>
												<td>{{ @$subjects_name->id }}</td>
												<td>{{ @$subjects_name->subject_name }}</td>
					...
					{{-- End Teacher Subject Tab --}}

					{{-- Start provide_inventory Tab --}}
					<div role="tabpanel" class="tab-pane fade {{ Session::get('staffInventory') == 'active' ? 'show active' : '' }}" id="provide_inventory">
						<div class="white-box">
							<div class="text-right mb-20">
								<button type="button" data-toggle="modal"
								data-target="#add_inventory_madal"
								class="primary-btn tr-bg text-uppercase bord-rad">
									@lang('common.add')
									<span class="pl ti-plus"></span>
								</button>
									...
									<table id="" class="table simple-table table-responsive school-table" cellspacing="0">
										<thead>
											<tr>
												...
												<th width="20%">@lang('common.item_name')</th>
												<th width="20%">@lang('common.date_of_given')</th>
												<th width="15%">@lang('common.description')</th>
												<th width="20%">@lang('common.action')</th>
											</tr>
										</thead>
										<tbody>
											@if (isset($inventories))
												@foreach ($inventories as $timeline)
											<tr>
												<td>{{ $timeline->id }}</td>
												<td>{{ $timeline->item_name }}</h5></td>
												<td>
													{{ $timeline->date_of_given != '' ? dateConvert($timeline->date_of_given) : '' }}
												...
												<td>
													...
													title="@lang('comom.delete_item')"
													href="{{ route('delete-inventory', $timeline->id) }}">
													<button	class="primary-btn small tr-bg">@lang('common.delete_item')</button>
													</a>
					...
					<!-- timeline form modal start-->
					<div class="modal fade admin-query" id="add_inventory_madal">
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">@lang('common.provide_inventory')</h4>
									<button type="button" class="close"
									data-dismiss="modal">&times;</button>
								</div>
								<div class="modal-body">
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<div class="row mt-25">
													<div class="col-lg-12">
														<div class="primary_input">
															<label class="primary_input_label" for="">@lang('common.item_name') <span class="text-danger"> *</span>
															</label>
															<input class="primary_input_field form-control"	type="text" name="item_name" value="" id="item_name" required>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12 mt-30">
												<div class="no-gutters input-right-icon">
													<div class="primary_input">                                                          
														<label class="primary_input_label" for="">@lang('common.date_of_given') <span class="text-danger"> *</span>
														</label>
														<div class="position-relative">
															<input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('date_of_given') ? ' is-invalid' : '' }}" id="startDate" type="text" name="date_of_given" autocomplete="off" value="{{ date('m/d/Y') }}" required>
															<label for="startDate" class="primary_input-icon pr-2">
																<i class="ti-calendar"
																id="admission-date-icon"></i>
															</label>
														</div>
														@if ($errors->has('date_of_given'))
														<span class="text-danger">
															{{ $errors->first('date_of_given') }}
														</span>
														@endif
													</div>
												</div>
											...
											<div class="col-lg-12 mt-30">
												<div class="primary_input">
													...
													for="">@lang('common.description') <span
													class="text-danger"> *</span> </label>
													<textarea class="primary_input_field form-control" cols="0" rows="3" name="description"	id="Description" required></textarea>
...
<script>
	...
	var template = `<div class="col-lg-12 mb-30 form-block" id="assign-inventory-1">
	<div class="row align-items-center">
	<div class="col-lg-5 mb-3 mb-lg-0">
	<input type="text" class="form-control" placeholder="@lang('common.item_name')" name="inventory[item][]">
</div>
<div class="col-lg-5 mb-3 mb-lg-0">
	<div class="primary_datepicker_input">
		<div class="no-gutters input-right-icon">
			<input type="text" id="date_of_given" class="form-control" placeholder="@lang('common.date_of_given')" name="inventory[date][]">
			<button class="btn-date" data-id="#date_of_given" type="button">
				<label class="m-0 p-0" for="date_of_given">
...
<div class="col-lg-2 col-12 text-center text-lg-left">
	<button class="primary-btn icon-only fix-gr-bg" id="removeInventory" onclick="deleteInventory(this)" type="button">
		<span class="ti-trash"></span>
	</button>
</div>
</div>
</div>`;
var form = $(".assign-subject");
$('.add-more-btn').on('click',function() {
form.append(template);
$('#inventory_form_save').show();
});

function deleteInventory(button) {
var form = button.closest("div.form-block");
