...
<html lang="{{ app()->getLocale() }}" @if(userRtlLtl()==1) dir="rtl" class="rtl" @endif>
	<head>
		...
		<style>
			...
			.small_logo_crm, .sidebar_icon, .collaspe_icon, .serach_field-area, .header_middle, .sms-breadcrumb, .select_style, .header_notification_warp  {
    ...
    left: 220px !important;
		...
		<link rel="stylesheet" href="{{ asset('public/backEnd/css/custom-backend.css') }}" />
		<link rel="stylesheet" href="{{ asset('public/backEnd/css/custom-backend-k.css') }}" />
	</head>
	@php
	...
	<body id="{{userCurrentTheme()}}" class="admin" >
