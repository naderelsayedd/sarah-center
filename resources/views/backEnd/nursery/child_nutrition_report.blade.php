               ...
               <div id="accordion">
                  <div class="card">
                     <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="background-color:white;">
                        <h3 class="mb-0">
                           @lang('nursery.add_nutrition_report')
                        </h3>
                     </div>
                     <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                           <form action="{{ route('post-child-nutrition-report') }}" method="post">
                              @csrf
                              <div class="row mt-15" id="exam_shedule">
                                 <div class="col-lg-12">
                                    <div class="container">
                                       <div class="row mt-15">
                                          <div class="col-lg-12">
                                             <h3 class="mb-30">@lang('nursery.child_nutrition_report')</h3>
                                             <div class="row py-3">
                                                <div class="col-6">
                                                   <strong>@lang('nursery.child_name'):</strong>
                                                   <select id="student-select" name="student_id" class="primary_select form-control">
                                             ...
                                             <div class="row" id="form-container">
                                                <div class="col-sm-3">
                                                   <span>@lang('nursery.meal')</span>
                                                   <input type="text" name="meal[]" placeholder="@lang('nursery.meal')" class="form-control">
                                                </div>
                                                <div class="col-sm-3">
                                                   <span>@lang('nursery.quantity') (ML.)</span>
                                                   <input type="number" placeholder="@lang('nursery.quantity')" name="quantity[]" class="form-control">
                                                </div>
                                                <div class="col-sm-3">
                        ...
                        <div class="card-body">
                           ...
                           <div class="report-table">
                              <table class="table table-bordered">
                                 ...
                                 <tbody>
                                 <?php foreach ($nutrition_report as $key => $value): ?>
                                       <tr>
                                          <td>{{ $key+1 }}</td>
                                          <td>{{$value->date}}</td>
        ...
        $(document).on('click', '.add-more', function() {
            var newRow = `
                <div class="row form-group" style="margin-left: 0%;width: 100%;">
                    <div class="col-sm-3">
                        <input type="text" name="meal[]" class="form-control" placeholder="@lang('nursery.meal')">
                    </div>
                    <div class="col-sm-3">
                        <input type="number" name="quantity[]" class="form-control" placeholder="@lang('nursery.quantity')">
                    </div>
                    <div class="col-sm-3">
                        <input type="time" name="time[]" class="form-control" placeholder="@lang('nursery.time')">
                    </div>
                    <div class="col-sm-2">
                        <input type="text" name="notes[]" class="form-control" placeholder="@lang('nursery.notes')">
                    </div>
                    <div class="col-sm-1">
