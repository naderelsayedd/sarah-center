               ...
               <div id="accordion">
                  <div class="card">
                     <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="background-color:white">
                        <h3 class="mb-0">
                           @lang('nursery.add_child_sleep_report')
                        </h3>
                     </div>
                     <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                           <form action="{{ route('post-child-sleep-report') }}" method="post">
                              @csrf
                              <div class="row mt-15" id="exam_shedule">
                                 <div class="col-lg-12">
                                    <div class="container">
                                       <div class="row mt-15">
                                          <div class="col-lg-12">
                                             <h3 class="mb-30">@lang('nursery.child_sleep_report')</h3>
                                             <div class="row">
                                                <div class="col-6">
                                             ...
                                             <div class="row" id="form-container">
                                                <div class="col-sm-3">
                                                   <span>@lang('nursery.sleep_from')</span>
                                                   <input type="time" name="sleep_from[]" placeholder="@lang('nursery.sleep_from')" class="form-control">
                                                </div>
                                                <div class="col-sm-3">
                                                   <span>@lang('nursery.sleep_till')</span>
                                                   <input type="time" placeholder="@lang('nursery.sleep_till')" name="sleep_till[]" class="form-control">
                                                </div>
                                                <div class="col-sm-3">
                                                   <span>@lang('nursery.quality_of_sleep')</span>
                                                   <input type="text" placeholder="@lang('nursery.quality_of_sleep')" name="quality_of_sleep[]" class="form-control">
                                                </div>
                                                <div class="col-sm-2">
