                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                <div class="row">
									...
									<div class="col-lg-6"> 
                                        <div class="primary_input">
                                            <select class="primary_select  form-control{{ $errors->has('class_id') ? ' is-invalid' : '' }} mb-30" name="class_id">
                                                <option data-display="@lang('front_settings.course_class')*" value="">@lang('common.select') *</option>
                                                @foreach($classes as $class)
                                                    <option value="{{$class->id}}" {{ (@$add_course->class_id == $class->id) ? 'selected' :''}}>{{$class->class_name}}</option>
                                                @endforeach
                                            </select>
