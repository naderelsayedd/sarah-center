...
<style>
	...
	#main-nav-for-chat {display:none;}
	.sms-breadcrumb {display:none;}
	#main-content {
...
<section class="student-details" id="DivBody">
	<a href="javascript:void(0);" class="primary-btn small fix-gr-bg" id="download" onclick="PrintGridData()">@lang('common.download')  </a>
		...
		<div class="row">
			...
			<div class="col-lg-9 student-details up_admin_visitor">
				<ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
					...
					@endif
					<li class="nav-item">
						<a class="nav-link" href="#transportation" role="tab" data-toggle="tab">@lang('student.transportation')</a>
					</li>
					
					<li class="nav-item">
						<a class="nav-link" href="#certificate" role="tab" data-toggle="tab">@lang('admin.certificate')</a>
					</li>
					
					<li class="nav-item {{ Session::get('advance_evaluation') == 'active' ? 'active' : '' }}">
						<a class="nav-link" href="#advance_evaluation" role="tab" data-toggle="tab">@lang('student.advance_evaluation')</a>
					</li>
				...
				<div class="tab-content">
					...
					<!-- Start transportation Tab -->
					@include('backEnd.studentInformation.inc._transportation')
					<!-- End transportation Tab -->
					
					<!-- Start transportation Tab -->
					@include('backEnd.studentInformation.inc._certificate')
					<!-- End transportation Tab -->
					
					
					<!-- Start transportation Tab -->
					@if(userRtlLtl()==1)
					@include('backEnd.studentInformation.inc._advance_evaluation')
					@else 
					@include('backEnd.studentInformation.inc._advance_evaluation_en')
					@endif
					<!-- End transportation Tab -->
