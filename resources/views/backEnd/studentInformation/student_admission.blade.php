                    ...
                    <div class="white-box">
                        <div class="">
                            ...
                            <div class="row mb-15 mt-15">
                                ...
                                @endphp
                                <div class="col-lg-3">
                                     <div class="col-lg-12" id="select_class_div">
                                        <label class="primary_input_label" for="">
                                            {{ __('common.class') }}
                                            <span class="text-danger"> *</span>
                                            <a href="javascript:void();" onclick="showPop('modalPopAddClass','add_new_class','select_class','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Class" data-original-title="Add Class"><span class="ti-plus"></span> Add</a>
                                        </label>
                                        <select
                                            class="primary_select form-control{{ $errors->has('class') ? ' is-invalid' : '' }}"
                                            name="class" id="select_class">
                                            <option
                                ...
                                @if (!empty(old('class')))
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <label class="primary_input_label" for="">
                                            {{ __('common.section') }}
                                            <span class="text-danger"> *</span>
                                            <a href="javascript:void(0);" onclick="showPop('modalPopAddSection','add_new_section','select_section','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Section" data-original-title="Add Section"><span class="ti-plus"></span> Add</a>
                                        </label>
                                            <select
                            ...
                            <div class="row mb-15">
                                @if (is_show('first_name'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('common.full_name')
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input ">
                                        <label class="primary_input_label" for="">@lang('student.age')
                                            @if (is_required('age') == true)
                                                <span class="text-danger"> *</span>
                                            @endif
                                        </label>
                                        <input
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input
                                                ...
                                                type="number" name="national_id_number"
                                                value="{{ old('national_id_number') }}" pattern="[0-9]+" maxlength="15">
                            ...
                            <div class="row mb-15">
                                ...
                                @if (is_show('student_category_id'))
                                    <div class="col-lg-4">
                                        <div class="primary_input ">
                                            <div class="primary_input " id="select_category_div">
                                                <label class="primary_input_label" for="">
                                                    @lang('student.category')
                                                    @if (is_required('student_category_id') == true)
                                                        <span class="text-danger"> *</span>
                                                    @endif
                                                    <a href="javascript:void();" onclick="showPop('modalPopAddCategory','add_new_category','select_category','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Category" data-original-title="Add Category"><span class="ti-plus"></span> Add</a>
                                                </label>
                                                <select class="primary_select form-control{{ $errors->has('student_category_id') ? ' is-invalid' : '' }}" name="student_category_id" id="select_category">
                                                    <option
                                            ...
                                            <div class="primary_input " id="select_category_div">
                                                <label class="primary_input_label" for="">@lang('student.group')
                                                    @if (is_required('student_group_id') == true)
                                                        <span class="text-danger"> *</span>
                                                    @endif
                                                    <a href="javascript:void();" onclick="showPop('modalPopAddGroup','add_new_group','select_group','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Group" data-original-title="Add Group"><span class="ti-plus"></span> Add</a>
                                                </label>
                                                <select
                                                    class="primary_select form-control{{ $errors->has('student_group_id') ? ' is-invalid' : '' }}"
                                                    name="student_group_id" id="select_group">
                                                    <option
                                ...
                                <div class="parent_details" id="parent_details">
                                    ...
                                    <div class="row mb-15 mt-30">
                                        @if (is_show('fathers_name'))
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.father_name') <span class="text-danger"> *</span>
                                        ...
                                        @if (is_show('fathers_phone'))
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.father_phone') <span class="text-danger"> *</span>
                                        ...
                                        @if (is_show('guardians_address'))
                                            <div class="col-lg-12">
                                                <div class="primary_input ">
                                                    ...
                                                    <input type="text" autocomplete="off" class="primary_input_field form-control{{ $errors->has('guardians_address') ? ' is-invalid' : '' }}" name="guardians_address" id="guardians_address" value="{{ old('guardians_address') }}">
                                                    <input type="hidden" id="guardians_address_lat" name="guardians_address_lat" />
                                                    <input type="hidden" id="guardians_address_long" name="guardians_address_long" />
                                                    @if ($errors->has('guardians_address'))
                                                        <span class="text-danger">
                                                            {{ $errors->first('guardians_address') }}
                                                        </span>
                                                    @endif
                                                    <div id="guardians_address_map"></div>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @if (is_show('current_address'))
                                    <div class="col-lg-6">
                                        <div class="primary_input  mt-20">
                                            ...
                                            <input type="text" class="primary_input_field form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}" name="current_address" id="current_address" value="{{ old('current_address') }}" />
                                            <input type="hidden" id="current_address_lat"  name="current_address_lat" />
                                            <input type="hidden" id="current_address_long"  name="current_address_long" />
                                            ...
                                            @endif
                                            <div id="current_address_map"></div>
                                        </div>
                                    </div>
                                @endif
                                @if (is_show('permanent_address'))
                                    <div class="col-lg-6">
                                        <div class="primary_input  mt-20">
                                            ...
                                            <input type="text" class="primary_input_field form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}" name="permanent_address" id="permanent_address" value="{{ old('permanent_address') }}">
                                            <input type="hidden" id="permanent_address_lat" name="permanent_address_lat" />
                                            <input type="hidden" id="permanent_address_long" name="permanent_address_long" />
                                            @if ($errors->has('permanent_address'))
                                                <span class="text-danger">
                                                    {{ $errors->first('permanent_address') }}
                                                </span>
                                            @endif
                                            <div id="permanent_address_map"></div>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input
                                                ...
                                                type="hidden"
                                                name="document_title_1" value="@lang('student.document_01_title')">
                                        ...
                                        <div class="primary_input">
                                            <div class="primary_file_uploader">
                                                <input class="primary_input_field" type="text" id="placeholderFileOneName"
                                                    placeholder="@if (is_required('document_file_1') == true) * @endif"
                                                    readonly="">
                                                <button class="" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                    ...
                                    <div class="primary_input">
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text" id="placeholderFileTwoName"
                                                placeholder="@if (is_required('document_file_2') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                    ...
                                    <div class="primary_input">
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text"
                                                ...
                                                placeholder="@if (is_required('document_file_3') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                    ...
                                    <div class="primary_input">
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text"
                                                ...
                                                placeholder="@if (is_required('document_file_4') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
