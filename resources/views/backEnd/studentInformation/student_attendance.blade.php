                                                ...
                                                <div class="d-flex radio-btn-flex">
                                                    <div class="mr-20">
                                                        <input type="radio"
                                                            ...
                                                            id="attendanceP{{$student->id}}" value="P" onclick="javascript:document.getElementById('attendanceA{{$student->id}}excuse').style.display = 'none'"
                                                    ...
                                                    <div class="mr-20">
                                                        <input type="radio"
                                                            name="attendance[{{$student->id}}][attendance_type]"
                                                            id="attendanceL{{$student->id}}" value="L" onclick="javascript:document.getElementById('attendanceA{{$student->id}}excuse').style.display = 'none'"
                                                    ...
                                                    <div class="mr-20">
                                                        <input type="radio"
                                                            name="attendance[{{$student->id}}][attendance_type]"
                                                            id="attendanceA{{$student->id}}" value="A" onclick="javascript:document.getElementById('attendanceA{{$student->id}}excuse').style.display = 'block'"
                                                            class="common-radio attendance_type"
														...
														<div class="row" id="attendanceA{{$student->id}}excuse" {{$student->studentDetail->DateWiseAttendances !=null ? ($student->studentDetail->DateWiseAttendances->attendance_type == "A" ? 'style=display:block' :'style=display:none'):'style=display:none'}}>
															<input type="radio" name="attendance[{{$student->id}}][attendance_excuse]" id="attendanceWXC{{$student->id}}" value="WXC" class="common-radio attendance_type"
															{{$student->studentDetail->DateWiseAttendances !=null ? ($student->studentDetail->DateWiseAttendances->attendance_excuse == "WXC" ? 'checked' :''):''}}>
															<label for="attendanceWXC{{$student->id}}">@lang('student.withexcuse')</label>
															
															<input type="radio" name="attendance[{{$student->id}}][attendance_excuse]" id="attendanceWOXC{{$student->id}}" value="WOXC" class="common-radio attendance_type"
															{{$student->studentDetail->DateWiseAttendances !=null ? ($student->studentDetail->DateWiseAttendances->attendance_excuse == "WOXC" ? 'checked' :''):''}}>
															<label for="attendanceWOXC{{$student->id}}">@lang('student.withoutexcuse')</label>
														</div>
                                                    </div>
                                                    <div>
                                                        <input type="radio"
                                                            name="attendance[{{$student->id}}][attendance_type]"
                                                            id="attendanceH{{$student->id}}" value="F" onclick="javascript:document.getElementById('attendanceA{{$student->id}}excuse').style.display = 'none'"
                                                            class="common-radio attendance_type"
