                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											...
											@php
													echo $btn = (userPermission('student_group_edit') ?
                                                    '<a  class="primary-btn small fix-gr-bg" href="' . route('student_group_edit', [$student_group->id]) . '" title="'. __('common.edit') .'" ><i class="ti-pencil" style="font-size: 20px;"></i></a><br>' : '').
													(userPermission('student_group_delete') ?
                                                    '<a  class="primary-btn small fix-gr-bg"  data-toggle="modal" data-target="#deleteStudentGroupModal'.$student_group->id.'"  href="#"  title="'. __('common.delete') .'" ><i class="ti-trash" style="font-size: 20px;"></i></a><br>' : '');
											@endphp
                                            <?php /*<x-drop-down>
