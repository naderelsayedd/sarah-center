				...
				<div class="white-box">
					<div class="">
						...
						<div class="row mb-20">
							...
							<div class="col-lg-3">
								<div class="primary_input">
									<label class="primary_input_label" for="">@lang('student.age')@if (is_required('age') == true)
										<span class="text-danger"> *</span>
										@endif
									</label>
									<input
						...
						<div class="row mb-20">
							...
							<div class="col-lg-3">
								<div class="primary_input">
									...
									value="{{ $student->national_id_no }}" pattern="[0-9]+" maxlength="15">
					...
					<div class="row mb-20">
						...
						<div class="col-lg-3">
							<div class="primary_input">
								 <div class="primary_input " id="select_category_div">
									...
									name="student_category_id" id="select_category">
										<option
						...
						<div class="col-lg-3">
							<div class="primary_input">
								<div class="primary_input " id="select_group_div">
						...
						<div class="row mt-35">
							<div class="col-lg-12">
								<div class="primary_input">
									...
									<input type="text" class="primary_input_field form-control{{ $errors->has('guardians_address') ? ' is-invalid' : '' }}" name="guardians_address" id="guardians_address" value="{{ $student->parents->guardians_address }}">
									<input type="hidden" id="guardians_address_lat" name="guardians_address_lat" value="{{ $student->parents->guardians_address_lat }}" />
									<input type="hidden" id="guardians_address_long" name="guardians_address_long" value="{{ $student->parents->guardians_address_long }}" />
					...
					<div class="row mb-30 mt-30">
						...
						<div class="col-lg-4">
							...
							<div class="primary_input mt-20">
								...
								<input type="text" class="primary_input_field form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}" name="current_address" id="current_address" value="{{ $student->current_address }}">
								<input type="hidden" id="current_address_lat" name="current_address_lat" value="{{ $student->current_address_lat }}" />
								<input type="hidden" id="current_address_long" name="current_address_long" value="{{ $student->current_address_long }}" />
						...
						<div class="col-lg-4">
							...
							<div class="primary_input mt-20">
								...
								<input type="text" class="primary_input_field form-control{{ $errors->has('permanent_address') ? ' is-invalid' : '' }}" name="permanent_address" id="permanent_address" value="{{ $student->permanent_address }}">
								<input type="hidden" id="permanent_address_lat" name="permanent_address_lat" value="{{ $student->permanent_address_lat }}" />
								<input type="hidden" id="permanent_address_long" name="permanent_address_long" value="{{ $student->permanent_address_long }}" />
				...
				<div class="row mb-20">
					...
					<div class="col-lg-3">
						<div class="primary_input">
							...
							<input class="primary_input_field" type="hidden" name="document_title_1"
							value="@lang('student.document_01_title')">
...
<script>
	setTimeout(() => {
		@if ($student->parents->guardians_address_lat && $student->parents->guardians_address_long && $student->parents->guardians_address)
		ShowMap('guardians_address_map','{{ $student->parents->guardians_address_lat }}','{{ $student->parents->guardians_address_long }}', '{{ $student->parents->guardians_address }}');
		@endif
		@if ($student->current_address_lat && $student->current_address_long && $student->current_address)
		ShowMap('current_address_map','{{ $student->current_address_lat }}','{{ $student->current_address_long }}', '{{ $student->current_address }}');
		@endif
		@if ($student->permanent_address_lat && $student->permanent_address_long && $student->permanent_address)
		ShowMap('permanent_address_map','{{ $student->permanent_address_lat }}','{{ $student->permanent_address_long }}', '{{ $student->permanent_address }}');
		@endif
	}, 3000);
</script>
@endsection