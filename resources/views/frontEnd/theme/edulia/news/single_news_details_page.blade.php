...
<style>
    ...
    <div class="inner-header bg-styles" style="background-image:url('{{asset($news->image)}}')">
  <div class="container">
    <div class="row">
      <div class="col-12"><div class="inner-title">المقالات</div></div>
    </div>
  </div>
</div>
    
    <section class="section_padding blog section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="blog_card">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="blog_details">
                                    <div class="blog_details_img text-center"><img src="{{asset($news->image)}}" alt="{{$news->news_title}}"></div>
