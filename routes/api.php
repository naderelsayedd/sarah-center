...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
	...
	Route::get('test-notification', 'SmApiController@pushNotificationAndroid');
	...
	Route::get('student-driver-list', 'SmApiController@getDriverStudentList');
	Route::post('driver-traking-start', 'SmApiController@driverTrakingStart');
	Route::post('send-notification-when-driver-reached', 'SmApiController@sendNotificationWhenDriverReached');
	Route::post('send-notification-when-parent-reached', 'SmApiController@sendNotificationWhenParentReached');
	Route::post('driver-traking-start-route', 'SmApiController@driverTrakingStartRoute');
	Route::post('driver-traking-end', 'SmApiController@driverTrakingEnd');
	Route::post('driver-traking-drop-student', 'SmApiController@driverTrakingDropStudent');
	Route::get('student-driver-traking-list', 'SmApiController@getDriverTrakingList');
	Route::get('student-driver-traking-route-list', 'SmApiController@getDriverTrakingRouteList');
