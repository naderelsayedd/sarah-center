...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
		...
		/*Ishit */
        Route::get('tracking-list', 'TrackingListController@index')->name('tracking-list');
        Route::get('ajax-student-driver-traking-list', 'TrackingListController@getDriverTrakingList');
	    Route::get('driver-route-list/{id}/{type}', 'TrackingListController@getDriverTrakingRouteList')->name('driver-route-list');
        Route::get('ajax-student-route-list', 'TrackingListController@getStudentsTrakingRouteList');

		 /*get class section by class_id*/
        Route::get('get-sections', 'HomeController@getSections')->name('get-class-section');
        Route::post('save-class-routine', 'HomeController@saveClassRoutine')->name('save-class-routine');
		Route::post('upadte-class-routine-time', 'HomeController@updateTimeClassRoutine')->name('upadte-class-routine-time');
		Route::get('get-class-routine-time', 'HomeController@getClassRoutineTime')->name('get-class-routine-time');
		...
		Route::post('class-store-pop', ['as' => 'class_store_popup', 'uses' => 'Admin\Academics\SmClassController@storepopup']); 
		...
		Route::post('parent-comfirmation', ['as' => 'parent_comfirmation', 'uses' => 'Parent\SmParentPanelController@parentConfirmation']);
		...
		Route::post('section-store-popup', ['as' => 'section_store_popup', 'uses' => 'Admin\Academics\SmSectionController@storepopup']);
		...
		Route::post('subject-store-popup', ['as' => 'subject_store_popup', 'uses' => 'Admin\Academics\SmSubjectController@storepopup']);
...
Route::get('exam-routine/print/{exam_id}', 'Admin\Examination\SmExamRoutineController@examRoutineReportSearchPrint')->name('exam-routine/print');
        ...
        Route::post('student-category-store-popup', ['as' => 'student_category_store_popup', 'uses' => 'Admin\StudentInfo\SmStudentCategoryController@storepop']);
        ...
        Route::post('student-group-store-popup', ['as' => 'student_group_store_popup', 'uses' => 'Admin\StudentInfo\SmStudentGroupController@storepop']);
		...
		/* Nursery Module starts from here (Manvendra)*/
        Route::get('child-medication', 'Admin\Nursery\childNurserySectionController@medicationReport')->name('child-medication')->middleware('userRolePermission:child-medication');
        Route::post('child-medication-report-submit', 'Admin\Nursery\childNurserySectionController@medicationReportPost')->name('post-child-medication-report')->middleware('userRolePermission:child-medication-report');

        Route::get('child-sleep', 'Admin\Nursery\childNurserySectionController@childSleepReport')->name('child-sleep')->middleware('userRolePermission:child-sleep');
        Route::post('child-sleep-report-submit', 'Admin\Nursery\childNurserySectionController@sleepReportPost')->name('post-child-sleep-report')->middleware('userRolePermission:child-nutrition-report');

        Route::get('child-nutrition', 'Admin\Nursery\childNurserySectionController@nutritionReport')->name('child-nutrition')->middleware('userRolePermission:child-nutrition');
        Route::post('child-nutrition-report-submit', 'Admin\Nursery\childNurserySectionController@nutritionReportPost')->name('post-child-nutrition-report')->middleware('userRolePermission:child-nutrition-report');

        Route::get('child-cleaning', 'Admin\Nursery\childNurserySectionController@index')->name('child-cleaning')->middleware('userRolePermission:child-cleaning');
        Route::post('child-cleaning-report-submit', 'Admin\Nursery\childNurserySectionController@saveReport')->name('post-child-cleaning-report')->middleware('userRolePermission:child-cleaning-report');

        Route::get('get-nursery-report', 'Admin\Nursery\childNurserySectionController@getReport')->name('get-nursery-report')->middleware('userRolePermission:child-report');
        Route::post('post-nursery-report', 'Admin\Nursery\childNurserySectionController@postNurseryReport')->name('post-nursery-report')->middleware('userRolePermission:child-report');

        Route::get('download-child-cleaning-report/{id}', 'Admin\Nursery\childNurserySectionController@downloadChildCleaningReport')->name('download-child-cleaning-report');

        Route::get('download-child-medication-report/{id}/{date}', 'Admin\Nursery\childNurserySectionController@downloadChildMedicationReport')->name('download-child-medication-report');

        Route::get('download-child-nutrition-report/{id}/{date}', 'Admin\Nursery\childNurserySectionController@downloadChildNutritionReport')->name('download-child-nutrition-report');

        Route::get('download-child-sleep-report/{id}/{date}', 'Admin\Nursery\childNurserySectionController@downloadChildSleepReport')->name('download-child-sleep-report');
 ...
 /*quiz routes starts from here (Manvendra)*/
        /*-------Quiz Category Routes--------*/
        Route::get('quiz_category', 'Admin\Quiz\QuizController@index')->name('quiz')->middleware('userRolePermission:quiz_category');
        Route::post('quiz_category', 'Admin\Quiz\QuizController@quizCategory')->name('quiz_category')->middleware('userRolePermission:quiz_category');
        Route::post('quiz_category_update', 'Admin\Quiz\QuizController@quizCategoryUpdate')->name('quiz_category_update')->middleware('userRolePermission:quiz_category_update');
        Route::post('quiz_category_store', 'Admin\Quiz\QuizController@quizCategoryStore')->name('quiz_category_store')->middleware('userRolePermission:quiz_category_store');
        Route::get('quiz_category_edit/{id}', 'Admin\Quiz\QuizController@quizCategoryEdit')->name('quiz_category_edit')->middleware('userRolePermission:quiz_category_edit');
         Route::get('quiz_category_delete/{id}', 'Admin\Quiz\QuizController@quizCategoryDelete')->name('quiz_category_delete')->middleware('userRolePermission:quiz_category_delete');
        /*----Quiz Category Routes end------*/

        /*---Quiz Routes-----*/
        Route::get('quiz', 'Admin\Quiz\QuizController@createQuiz')->name('create_quiz')->middleware('userRolePermission:create_quiz');
        Route::post('quiz', 'Admin\Quiz\QuizController@quiz')->name('quiz')->middleware('userRolePermission:quiz');
        Route::post('quiz_update', 'Admin\Quiz\QuizController@quizUpdate')->name('quiz_update')->middleware('userRolePermission:quiz_update');
        Route::post('quiz_store', 'Admin\Quiz\QuizController@quizStore')->name('quiz_store')->middleware('userRolePermission:quiz_store');
        Route::get('quiz_edit/{id}', 'Admin\Quiz\QuizController@quizEdit')->name('quiz_edit')->middleware('userRolePermission:quiz_edit');
         Route::get('quiz_delete/{id}', 'Admin\Quiz\QuizController@quizDelete')->name('quiz_delete')->middleware('userRolePermission:quiz_delete');
        /*Quiz Routes end*/

        /*----Quiz Questions Routes*/
        Route::get('add_question/{id}', 'Admin\Quiz\QuizController@addQuestion')->name('add_question')->middleware('userRolePermission:add_question');
        Route::post('question', 'Admin\Quiz\QuizController@quiz')->name('question');
        Route::post('question_update', 'Admin\Quiz\QuizController@questionUpdate')->name('question_update')->middleware('userRolePermission:question_update');
        Route::post('question_store', 'Admin\Quiz\QuizController@questionStore')->name('question_store')->middleware('userRolePermission:question_store');
        Route::get('question_edit/{id}', 'Admin\Quiz\QuizController@questionEdit')->name('question_edit')->middleware('userRolePermission:question_edit');
         Route::get('question_delete/{id}', 'Admin\Quiz\QuizController@questionDelete')->name('question_delete')->middleware('userRolePermission:question_delete');
         Route::get('/get-courses', 'Admin\Quiz\QuizController@getCourses')->name('get_courses')->middleware('userRolePermission:get_courses');
        /*----Quiz Questions Routes end*/
        ...
        Route::post('department-popup', 'Admin\Hr\SmHumanDepartmentController@storepop')->name('department-store-popup');
		...
		Route::get('teacher-evaluation-admin', 'Admin\Hr\SmStaffController@teacherList')->name('teacher-evaluation-admin')->middleware('userRolePermission:teacher-evaluation-admin');
        ...
        Route::post('designation-pop', 'Admin\Hr\SmDesignationController@storepop')->name('designation-store-pop');
		...
		Route::get('export_excel', 'Admin\Accounts\SmChartOfAccountController@export_excel')->name('export_excel');
		Route::post('get-chart-of-account', ['as' => 'get_chart_of_account', 'uses' => 'Admin\Accounts\SmChartOfAccountController@getChartOfAccount']);
		Route::post('get-chart-of-head', ['as' => 'get_chart_of_head', 'uses' => 'Admin\Accounts\SmChartOfAccountController@getChartOfHead']);
		...
		/*event time table for teacher starts form here (Manvendra)*/
        Route::post('submit_event_time_table', 'Teacher\EventTimeTableController@addEventTimeTable')->name('teacher.submit_event_time_table');
        /*event time table for teacher ends here*/
		
		/*gallery upload route starts here (Manvendra)*/
        Route::post('upload_gallery', 'Teacher\GalleryUploadController@uploadGalleryImage')->name('uploadGallery');
		Route::post('uploadSingleImage', 'Teacher\GalleryUploadController@uploadSingleImage')->name('uploadSingleImage');
        Route::get('get-gallery-images', 'Teacher\GalleryUploadController@getGalleryImages')->name('getGalleryImages');
        Route::get('gallery-delete/{id}','Teacher\GalleryUploadController@destroy')->name('deleteGallery');
        Route::get('deleteSingleImage/{id}','Teacher\GalleryUploadController@singleDelete')->name('deleteSingleImage');
        Route::get('gallery', 'Teacher\GalleryUploadController@listing')->name('galleryListing');
        Route::get('gallery-details-page/{id}', 'Teacher\GalleryUploadController@galleryDetails')->name('galleryDetailsPage');
        Route::get('download-gallery/{id}', 'Teacher\GalleryUploadController@downloadGallery')->name('downloadGallery');
		Route::get('download-gallery-all', 'Teacher\GalleryUploadController@downloadGalleryAll')->name('downloadGalleryAll');

        Route::get('download-single-image/{id}', 'Teacher\GalleryUploadController@downloadSingleImage')->name('downloadSingleImage');  

        // gallery comments
        Route::get('comments/{imageId}/{galleryId}', 'Teacher\GalleryUploadController@comments')->name('comments.index');
        Route::post('comments', 'Teacher\GalleryUploadController@commentStore')->name('comments.store');
        Route::get('comments/form/{imageId}/{galleryId}', 'Teacher\GalleryUploadController@form')->name('comments.form');
        /*gallery uplaod route ends here*/
        
        /*child report route starts from here (Manvendra)*/
        Route::get('/daily_report_create', 'Teacher\DailyChildReportController@index')->name('dailyChildReport.index');
        Route::post('/daily_report_submit', 'Teacher\DailyChildReportController@store')->name('dailyReportSubmit');
        Route::get('/daily_report', 'Teacher\DailyChildReportController@view')->name('dailyChildReport.view');
        Route::get('/daily_report_delete/{id}', 'Teacher\DailyChildReportController@destroy')->name('dailyChildReport.delete');
        Route::get('/download-pdf/{id}', 'Teacher\DailyChildReportController@downloadPDF')->name('download.pdf');

        /*child report route end here*/
		...
		Route::get('student_approval_pending_list', ['as' => 'student_approval_pending_list', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@studentPendingList'])->middleware('userRolePermission:student_approval_pending_list');
		...
		Route::post('student-teacher-evaluation', 'Admin\StudentInfo\SmStudentAdmissionController@studentTeacherEvaluation')->name('student-teacher-evaluation');
        ...
        Route::get('reports', ['as' => 'reports', 'uses' => 'Admin\StudentInfo\SmStudentReportController@reports'])->middleware('userRolePermission:student_report');
		...
		Route::post('student-unapprove', ['as' => 'student_unapprove', 'uses' => 'SmStudentAdmissionController@unapproveStudent']);
		...
		/*staff evaluation starts from here (Manvendra)*/
        Route::get('staff-evaluation', ['as' => 'staff_evaluation', 'uses' => 'Admin\Hr\SmStaffController@staffEvaluation'])->middleware('userRolePermission:staff_evaluation');
        Route::post('evaluate-staff', 'Admin\Hr\SmStaffController@evaluateStaff')->name('evaluateStaff')->middleware('userRolePermission:staff_evaluation');
        Route::post('second-evaluate-staff', 'Admin\Hr\SmStaffController@secondEvaluateStaff')->name('secondEvaluateStaff')->middleware('userRolePermission:staff_evaluation');
        Route::post('third-evaluate-staff', 'Admin\Hr\SmStaffController@thirdEvaluateStaff')->name('thirdEvaluateStaff')->middleware('userRolePermission:staff_evaluation');
        Route::post('fourth-evaluate-staff', 'Admin\Hr\SmStaffController@fourthEvaluateStaff')->name('fourthEvaluateStaff')->middleware('userRolePermission:staff_evaluation');
        Route::get('search-staff-evaluation', ['as' => 'search_staff_evaluation', 'uses' => 'Admin\Hr\SmStaffController@searchStaffEvaluation'])->middleware('userRolePermission:staff_evaluation');
        Route::post('search-evaluate-staff', 'Admin\Hr\SmStaffController@searchEvaluateStaff')->name('searchEvaluateStaff')->middleware('userRolePermission:staff_evaluation');

        /*for monthly and weekly basis in char form*/
        Route::get('search-staff-evaluation-monthly', ['as' => 'search_staff_evaluation_monthly', 'uses' => 'Admin\Hr\SmStaffController@searchStaffEvaluationMonthly'])->middleware('userRolePermission:staff_evaluation');
        Route::post('search-evaluate-staff-monthly', 'Admin\Hr\SmStaffController@searchEvaluateStaffMonthly')->name('searchEvaluateStaffMonthly')->middleware('userRolePermission:staff_evaluation');
        
        /*staff evaluation ends here*/
        ...
        Route::post('save_upload_document', 'Admin\Hr\SmStaffController@saveUploadDocument')->name('save_upload_document');
		 Route::post('save_staff_inventory', 'Admin\Hr\SmStaffController@saveStaffInventory')->name('save_staff_inventory');
		 Route::get('delete-inventory/{id}', 'Admin\Hr\SmStaffController@deleteInventory')->name('delete-inventory');
	...
	Route::post('get-sub-categories', 'Admin\FrontSettings\SmCourseListController@getSubCategories')->name('get-sub-categories');
	...
	Route::get('evaluation-questionnair-list-ajax', 'DatatableQueryController@evaluationQuestionnairListAjax')->name('evaluation-questionnair-list-ajax');
	Route::get('evaluation-questionnair-list-ajax/{id}', 'DatatableQueryController@editEveluationQuestionnair')->name('evaluation-questionnair-list-edit');
	...
	Route::get('teacher-questionnaire', [TeacherEvaluationController::class, 'teacherEvaluationQuestionnair'])->name('teacher-questionnaire');
	...
	Route::post('saveTeacherEvaluationQuestionnair', [TeacherEvaluationController::class, 'savTeacherEvaluationQuestionnair'])->name('saveTeacherEvaluationQuestionnair');
	Route::post('evaluation-questionnair-list-get-update-ajax', [TeacherEvaluationController::class, 'teacherEvaluationQuestionnairUpdateShow'])->name('evaluation-questionnair-update-show');
	Route::post('evaluationQuestionnairUpdateSubmit', [TeacherEvaluationController::class, 'teacherEvaluationQuestionnairUpdateSubmit'])->name('evaluationQuestionnairUpdateSubmit');
	Route::get('delete-questionnair-view/{id}', [TeacherEvaluationController::class, 'questionnairItemView'])->name('delete-questionnair-view');
    Route::get('delete-questionnair/{id}', [TeacherEvaluationController::class, 'questionnairItem'])->name('delete-questionnair');
	//Route::get('delete-item-view/{id}', 'Admin\Inventory\SmItemController@deleteItemView')->name('delete-item-view')->middleware('userRolePermission:delete-item-view');
    ...
    Route::post('teacher-evaluation-question', [TeacherEvaluationController::class, 'teacherEvaluationQuestion'])->name('teacher-evaluation-question');

Route::post('teacher-evaluation-question-admin', [TeacherEvaluationController::class, 'teacherEvaluationQuestionAdmin'])->name('teacher-evaluation-question-admin');
	...
	Route::post('set-user-theme', ['as' => 'set_user_theme', 'uses' => 'Admin\SystemSettings\SmSystemSettingController@setUserTheme']);
	Route::post('set-user-attendance', ['as' => 'set_user_attendance', 'uses' => 'Admin\SystemSettings\SmSystemSettingController@setUserAttendance']); 
	Route::post('set-user-attendance-checkout', ['as' => 'set_user_attendance_checkout', 'uses' => 'Admin\SystemSettings\SmSystemSettingController@setUserAttendanceCheckout']); 
	
	Route::post('send-notification-when-parent-reached-web', 'Admin\SystemSettings\SmNotificationController@sendNotificationWhenParentReachedWeb');
	
	/* gallery upload route starts here (Manvendra)*/
	Route::post('upload_gallery', 'Teacher\GalleryUploadController@uploadGalleryImage')->name('uploadGallery');
	Route::delete('/delete/{id}','Teacher\GalleryUploadController@destroy')->name('deleteGallery');
	/* gallery uplaod route ends here */
	
	
	/*subscription plan starts from here (Manvendra)*/
    Route::get('/subscription-plans', 'Admin\Subscription\SubscriptionPlanController@index')->name('subscription-plans.index')->middleware('userRolePermission:subscription-plans');
    Route::get('/subscription-plans/create', 'Admin\Subscription\SubscriptionPlanController@create')->name('subscription-plans.create')->middleware('userRolePermission:subscription-plans');
    Route::post('/subscription-plans', 'Admin\Subscription\SubscriptionPlanController@store')->name('subscription-plans.store')->middleware('userRolePermission:subscription-plans');
    Route::get('/subscription-plans/{id}', 'Admin\Subscription\SubscriptionPlanController@show')->name('subscription-plans.show')->middleware('userRolePermission:subscription-plans');
    Route::get('/subscription-plans/{id}/edit', 'Admin\Subscription\SubscriptionPlanController@edit')->name('subscription-plans.edit')->middleware('userRolePermission:subscription-plans');
    Route::put('/subscription-plans/{id}', 'Admin\Subscription\SubscriptionPlanController@update')->name('subscription-plans.update')->middleware('userRolePermission:subscription-plans');
    Route::delete('/subscription-plans/{id}', 'Admin\Subscription\SubscriptionPlanController@destroy')->name('subscription-plans.delete')->middleware('userRolePermission:subscription-plans');
    Route::get('/subscription-plans-view', 'Admin\Subscription\SubscriptionPlanController@view')->name('subscription-plans.view')->middleware('userRolePermission:subscription-plans-view');
    /*subscription plan ends here*/


    /*interview for parent starts from here (Manvendra)*/
    Route::get('/parent-interviews', 'Admin\InterviewParent\ParentInterviewController@index')->name('interviews.parent.index');
    Route::post('/interviews/update/{id}', 'Admin\InterviewParent\ParentInterviewController@update')->name('interviews.parent.update');
    // Route::get('/interviews/edit/{id}', 'Admin\InterviewParent\ParentInterviewController@edit')->name('interviews.parent.edit');
    // Route::get('/interviews/destroy/{id}', 'Admin\InterviewParent\ParentInterviewController@destroy')->name('interviews.parent.destroy');
    /*interview for parent ends here*/
