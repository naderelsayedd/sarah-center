...
Route::group(['middleware' => ['XSS', 'subdomain','fees_due_check']], function () {
    ...
    Route::group(['middleware' => ['ParentMiddleware']], function () {
        ...
        Route::post('/interviews', 'Parent\SmParentPanelController@interviewStore')->name('interviews.store');
        ...
        Route::get('update-my-children/{id}', 'Parent\SmParentPanelController@UpdatemyChildren')->name('update-my-children');
        Route::post('my-children-update', 'Parent\SmParentPanelController@studentUpdate')->name('my-children-update');
        ...
        Route::get('parent/student-download-timeline-doc/{file_name}', ['as' => 'parent_student_download_timeline_doc', 'uses' => 'Parent\SmParentPanelController@StudentDownload']);
		   ...
		   /*--------Quiz Routes starts from here----------*/
        Route::get('quiz_list', 'Parent\QuizController@quizList')->name('quiz_list');
        Route::get('start_quiz/{id}/{student_id}', 'Parent\QuizController@startQuiz')->name('start_quiz');
        Route::post('/submit-quiz/{id}', 'Parent\QuizController@submitQuiz')->name('submit_quiz');
        Route::get('/quiz-result/{quiz_id}/{student_id}', 'Parent\QuizController@showQuizResult')->name('show_quiz_result');
