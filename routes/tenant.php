...
Route::group(['middleware' => []], function () {
    ...
    Route::group(['middleware' => ['XSS']], function () {
		...
		Route::get('register/{class_id}/{course_id}', 'SmFrontendController@register')->name('register_couse');
        Route::post('register/{class_id}/{course_id}', 'SmFrontendController@customer_register')->name('customer_register');
        ...
        Route::group(['middleware' => ['CheckUserMiddleware']], function () {
			...
			Route::get('/account/activation/{email}/{code}', 'SmAuthController@accountActivationConfirtmation')->name('accountActivationConfirtmation');
    ...
    Route::controller(FrontendController::class)->as('frontend.')->group(function ($routes) {
		...
		$routes->get('aboutus', 'aboutus')->name('aboutus');
		$routes->get('onsite-nursery', 'onsiteNursery')->name('onsite-nursery');
		$routes->get('onsite-kg', 'onsiteKg')->name('onsite-kg');
		$routes->get('intensive-education-remedial', 'intensiveEducationRemedial')->name('intensive-education-remedial');
		$routes->get('special-education', 'specialEducation')->name('special-education');
		$routes->get('online-nursery', 'onlineNursery')->name('online-nursery');
		$routes->get('primary-stage', 'primaryStage')->name('primary-stage');
		$routes->get('intermediate-stage', 'intermediateStage')->name('intermediate-stage');
		$routes->get('secondary-stage', 'secondaryStage')->name('secondary-stage');
		$routes->get('undergraduate-stage', 'undergraduateStage')->name('undergraduate-stage');
		$routes->get('photogallery', 'photoGallery')->name('photogallery');
		$routes->get('videogallery', 'videoGallery')->name('videogallery');
		$routes->get('contactus', 'contactus')->name('contactus');

		$routes->get('sections', 'sections')->name('sections');
		$routes->get('section-details/{id}', 'sectionDetails')->name('section-details')->where('id', '[0-9]+');
	...
	Route::get('buy-subscription', 'SmFrontendController@subscriptionList')->name('subscriptionList');
	Route::post('buy-subscription-session-id', 'Admin\Subscription\SubscriptionPlanController@getSessionId')->name('payment.getSessionId');
	Route::post('subscription-make-payment', 'Admin\Subscription\SubscriptionPlanController@makePayment')->name('subscription.makePayment');
	Route::get('payment-success-callback', 'Admin\Subscription\SubscriptionPlanController@successPayment')->name('payment-success-callback');
