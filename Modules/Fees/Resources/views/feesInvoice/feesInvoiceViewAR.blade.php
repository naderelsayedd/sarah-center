<?php $setting =generalSetting(); ?>
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        <div class="invoice_wrapper">
                ...
                <div class="container">
                    <div class="invoice_part_iner">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h4 class="fs-3" style="margin-bottom: 0px;float: left;"><img src="{{asset($setting->logo)}}" title="Metashops Education" width="130px" /></h4>
                            </div>
                        </div>
            ...
            <br>
            <table>
                <tfoot style="color:#000;display:inline-block;margin-right:0;direction:rtl;">
                    <tr>
                        <td>
