            ...
            <div class="col-lg-12">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mt-30-md" id="student-div">
                            <label class="primary_input_label" for="">@lang('common.select_student') <span class="text-danger">*</span></label>
                            <select class="primary_select  form-control{{ $errors->has('student_id') ? ' is-invalid' : '' }}" id="studentypeID" name="student_id">
