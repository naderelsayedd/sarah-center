                                ...
                                <div class="row mt-15">
                                   <div class="col-lg-12" id="select_subject_div">
										<label class="primary_input_label" for="">
											{{ __('common.subject') }}
											<span class="text-danger"> *</span>
											<a href="javascript:void(0);" onclick="showPop('modalPopAddSubject','add_new_subject','select_subject','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Section" data-original-title="Add Section"><span class="ti-plus"></span> Add</a>
										</label>
                                        <select
                                ...
                                <div class="row mt-15">
                                    ...
                                    <div class="col-lg-12" id="select_lesson_div">
                                        <label class="primary_input_label" for="">
                                            ...
                                            <span class="text-danger"> *</span>
											<a href="javascript:void(0);" onclick="showPop('modalPopAddLesson','add_new_lesson','select_lesson','select');" class="add_new pull-right" data-toggle="tooltip" title="Add Lesson" data-original-title="Add Lesson"><span class="ti-plus"></span> Add</a>
										</label>
