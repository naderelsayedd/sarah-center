...
Route::prefix('chat')->middleware('auth')->group(function() {
    ...
    Route::post('chat-search', [UserController::class, 'chatSearch'])->name('chat.search');
    ...
    /*new route 23-07-2024*/
    Route::post('chat-search-ajax', [ChatController::class, 'userSearchAjax'])->name('chat.search.user.ajax');

    Route::post('get-user-messages', [ChatController::class, 'userMessagesAjax'])->name('chat.search.user.get-user-messages');
    Route::post('get-group-messages', [ChatController::class, 'groupMessagesAjax'])->name('chat.search.group.get-group-messages');

    Route::post('search-messages', [ChatController::class, 'searcgMessagesAjax'])->name('chat.search.get-search-messages');
